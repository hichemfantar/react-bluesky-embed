...
- [localhost:5173/postThread/1629307668568633344](http://localhost:5173/postThread/1629307668568633344) renders dynamic post threads with SWR. `PostThread` already uses SWR and this page shows how to implement it manually.
