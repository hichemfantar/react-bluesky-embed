...
- [localhost:5173/postThread/did:plc:gru662w3omynujkgwebgeeof/3lbirib5xnc2u](http://localhost:5173/postThread/did:plc:gru662w3omynujkgwebgeeof/3lbirib5xnc2u) renders dynamic post threads with SWR. `PostThread` already uses SWR and this page shows how to implement it manually.
